...
::tip
Plus, you can pass props to layouts now! See [the](#layout-props-with-setpagelayout) [`setPageLayout`](#layout-props-with-setpagelayout) [improvements below](#layout-props-with-setpagelayout).
::
...
::callout{color="info" icon="i-lucide-badge-alert"}
...
## 🎨 Layout Props with `setPageLayout` {#layout-props-with-setpagelayout}
