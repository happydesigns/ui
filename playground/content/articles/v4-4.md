...
to: /docs/api/composables/create-use-async-data
---
...
Even better – the props are **fully typed** ([#34409](https://github.com/nuxt/nuxt/pull/34409)). If your layout defines props, you'll get autocomplete and type-checking in `definePageMeta`.
...
::callout{icon="i-lucide-bookmark" to="/docs/guide/directory-structure/layouts"}
...
---
icon: i-lucide-bookmark
to: /docs/guide/going-further/experimental-features#payloadextraction
---
Read more in **Docs > Guide > Going Further > Experimental Features**.
::
...
::callout{icon="i-lucide-bookmark" to="/docs/api/composables/use-cookie"}
...
::callout{icon="i-lucide-bookmark" to="/docs/api/utils/clear-nuxt-state"}
...
---
icon: i-lucide-bookmark
to: /docs/getting-started/transitions#view-transitions-api-experimental
---
...
---
icon: i-lucide-bookmark
to: /docs/guide/going-further/experimental-features#normalizecomponentnames
---
Read more in **Docs > Guide > Going Further > Experimental Features**.
::
...
![Build timings report printed to console](/assets/articles/v4-4/build-profiler.png)
...
::callout{icon="i-lucide-bookmark" to="/docs/api/commands/build"}
...
- **14,000x faster module ID parsing** – replaced `new URL()` + regex chain with a single `indexOf` + slice ([#34451](https://github.com/nuxt/nuxt/pull/34451))
- **Disabled NuxtLink visibility prefetching in dev** – stops Vite from discovering and reloading deps unnecessarily during development ([#34325](https://github.com/nuxt/nuxt/pull/34325))
